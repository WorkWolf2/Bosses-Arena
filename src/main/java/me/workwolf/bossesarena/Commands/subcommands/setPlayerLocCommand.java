...
public class setPlayerLocCommand extends SubCommand {

    private final FileManager fileManager = new FileManager();
    private final BossesArena plugin;

    public setPlayerLocCommand(BossesArena plugin) {
        this.plugin = plugin;
    }
    ...
    public String getDescription() {
        return "setup player tp location";
    }

    @Override
    public String getSyntax() {
        return "/ba setplayerloc <arena name>";
    }
    ...
    public void perform(CommandSender sender, String[] args) {
        ...
        if (!player.hasPermission("ba.*") || !player.hasPermission("ba.setplayerloc") || !player.isOp()) {
            return;
        }
        ...
        fileManager.setTeleportLoc(plugin, arenaName, world_name, x, y, z, yaw, pitch);
